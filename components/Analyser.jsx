...
const Analyser = () => {
  ...
  const analyzeText = () => {
    ...
    const countTokens = (tokens, group) => {
    ...
    const numPronouns = countTokens(tokens, pronouns);
    const numPrepositions = countTokens(tokens, prepositions);
    const numArticles = countTokens(tokens, articles);
      ...
      {analysis && (
        <div className="mt-6">
          ...
          <ul className="list-disc list-inside space-y-2 text-2xl">
            ...
            <li>Number of Pronouns: {analysis.numPronouns}</li>
            <li>Number of Prepositions: {analysis.numPrepositions}</li>
            <li>Number of Indefinite Articles: {analysis.numArticles}</li>
          </ul>
        </div>
      )}
    </div>
